  ...
  return (
    <div className="container app-body">
      ...
      <div className="row">
        <div className="col-xs-12 app-workspace">
          <div className="form-inline">
            ...
            <div className="form-group">
              ...
              <select className="form-control" id="year-list" name="year-list">
            ...
            <div className="form-group">
              ...
              <select id="report-list" className="form-control">
                <option value="">-- Choose --</option>
                <option value="1" data-api="/api/retailer/3/reports/1">
                  Product Summary
                </option>
              </select>
            </div>
          ...
          <div className="retailer-reports-app">
            ...
            <div
              style={{ padding: "2rem", paddingTop: "0", border: "solid 1px" }}
            >
              <TreeTable
                columns={[
                  {
        ...
        <a className="return-home" href="/plan/retailer/home">
          Back to Home
        </a>
      </div>
    </div>
